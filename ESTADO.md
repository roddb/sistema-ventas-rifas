...
### 2026-06-12 — Fase 12.1 + 12.2 implementadas (combo empanadas con gustos + cierre 30/6)
- **Tareas completadas (código + validación local, falta deploy)**: 12.1 (cierre auto 30/6 23:59) + 12.2 (combo de empanadas $12.000 con reparto exacto de gustos carne/jamón y queso).
- **Branch**: `feature/fase-12-combo-empanadas` (desde main).
...
- **Próxima**: merge a main + `./scripts/deploy.sh` a Cloud Run + smoke prod (inspección URLs preference MP) + compra real de tercero. Luego 12.3 (tickets) y 12.4 (talonario, espera medidas).
- **Bugs nuevos**: ninguno.
