...
### 2026-06-12 — Fase 12.1 + 12.2 DEPLOYADAS (combo empanadas con gustos + cierre 30/6)
- **Tareas completadas y EN PRODUCCIÓN (revision `00022-hzf`)**: 12.1 (cierre auto 30/6 23:59) + 12.2 (combo de empanadas $12.000 con reparto exacto de gustos carne/jamón y queso). App lista para difundir.
